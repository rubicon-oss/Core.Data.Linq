...
internal static class Error
{
  ...
  internal static Exception InconsistentAssociationAndKeyChange (object p0, object p1) =>
      (Exception)new InvalidOperationException (Strings.InconsistentAssociationAndKeyChange (p0, p1));
  ...
  internal static Exception CouldNotGetTableForSubtype (object p0, object p1) =>
      (Exception)new InvalidOperationException (Strings.CouldNotGetTableForSubtype (p0, p1));
  ...
  internal static Exception EntitySetModifiedDuringEnumeration () =>
      (Exception)new InvalidOperationException (Strings.EntitySetModifiedDuringEnumeration);

  internal static Exception ExpectedQueryableArgument (object p0, object p1) =>
      (Exception)new ArgumentException (Strings.ExpectedQueryableArgument (p0, p1));

  internal static Exception IdentityChangeNotAllowed (object p0, object p1) =>
      (Exception)new InvalidOperationException (Strings.IdentityChangeNotAllowed (p0, p1));

  internal static Exception DbGeneratedChangeNotAllowed (object p0, object p1) =>
      (Exception)new InvalidOperationException (Strings.DbGeneratedChangeNotAllowed (p0, p1));
  ...
  internal static Exception OptionsCannotBeModifiedAfterQuery () =>
      (Exception)new InvalidOperationException (Strings.OptionsCannotBeModifiedAfterQuery);

  internal static Exception DeferredLoadingRequiresObjectTracking () =>
      (Exception)new InvalidOperationException (Strings.DeferredLoadingRequiresObjectTracking);

  internal static Exception SubqueryDoesNotSupportOperator (object p0) =>
      (Exception)new NotSupportedException (Strings.SubqueryDoesNotSupportOperator (p0));
  ...
  internal static Exception SubqueryNotSupportedOnType (object p0, object p1) =>
      (Exception)new NotSupportedException (Strings.SubqueryNotSupportedOnType (p0, p1));
  ...
  internal static Exception LoadOptionsChangeNotAllowedAfterQuery () =>
      (Exception)new InvalidOperationException (Strings.LoadOptionsChangeNotAllowedAfterQuery);
  ...
  internal static Exception DataContextCannotBeUsedAfterDispose () =>
      (Exception)new ObjectDisposedException (Strings.DataContextCannotBeUsedAfterDispose);
  ...
  internal static Exception NonEntityAssociationMapping (object p0, object p1, object p2) =>
      (Exception)new InvalidOperationException (Strings.NonEntityAssociationMapping (p0, p1, p2));

  internal static Exception CannotPerformCUDOnReadOnlyTable (object p0) =>
      (Exception)new InvalidOperationException (Strings.CannotPerformCUDOnReadOnlyTable (p0));
  ...
  internal static Exception EntitySetDataBindingWithAbstractBaseClass (object p0) =>
      (Exception)new InvalidOperationException (Strings.EntitySetDataBindingWithAbstractBaseClass (p0));

  internal static Exception EntitySetDataBindingWithNonPublicDefaultConstructor (object p0) =>
      (Exception)new InvalidOperationException (Strings.EntitySetDataBindingWithNonPublicDefaultConstructor (p0));

  internal static Exception InvalidLoadOptionsLoadMemberSpecification () =>
      (Exception)new InvalidOperationException (Strings.InvalidLoadOptionsLoadMemberSpecification);
  ...
  internal static Exception CannotAttachAlreadyExistingEntity () =>
      (Exception)new InvalidOperationException (Strings.CannotAttachAlreadyExistingEntity);

  internal static Exception CannotAttachAsModifiedWithoutOriginalState () =>
      (Exception)new InvalidOperationException (Strings.CannotAttachAsModifiedWithoutOriginalState);

  internal static Exception CannotPerformOperationDuringSubmitChanges () =>
      (Exception)new InvalidOperationException (Strings.CannotPerformOperationDuringSubmitChanges);

  internal static Exception CannotPerformOperationOutsideSubmitChanges () =>
      (Exception)new InvalidOperationException (Strings.CannotPerformOperationOutsideSubmitChanges);

  internal static Exception CannotPerformOperationForUntrackedObject () =>
      (Exception)new InvalidOperationException (Strings.CannotPerformOperationForUntrackedObject);
  ...
  internal static Exception QueryWasCompiledForDifferentMappingSource () =>
      (Exception)new ArgumentException (Strings.QueryWasCompiledForDifferentMappingSource);
